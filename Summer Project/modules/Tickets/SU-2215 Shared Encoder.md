...
|-------------------------|--------------------------|---------------------------------|--------------------------------------------|----------------------------------------------|--------------------------------------------|---------------------------------------------------------------------------------------------------|--|--|--|
| Semantic Segmentation   | Supervised               | U-Net, FCN, DeepLab, PSPNet     | Cross-entropy, Dice loss                   | Cityscapes, PASCAL VOC, COCO                 | Pixel-wise class labels                    | Yes (e.g., DeepCluster, SEED, GANs)                                                               |  |  |  |
