...
- [ ] rviz up
- [ ] rqt up
- [ ] make sure lane_correlator is connected with everything else 
- [ ] play the rosbag
	- [ ] exclude certain topics 
- [ ] make sure by echoing the above topics
	- [ ] install localization related topic for echo
	- [ ] also make sure they are not getting echoed from bag file itself
- [ ] record the topics 
- [ ] plot the topics 
